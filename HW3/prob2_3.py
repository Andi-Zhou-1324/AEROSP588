...
alpha_new, f_x_new = LineSearch_Bracketing_new(a_init,func,mu_1,mu_2,sigma,x_k,p_k)
...
alpha_new, f_x_new = LineSearch_Bracketing_new(a_init,bean_function_ALL,mu_1,mu_2,sigma,x_k,p_k)
